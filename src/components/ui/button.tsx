...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center border-transparent text-sm font-medium whitespace-nowrap transition-all outline-none select-none cursor-pointer active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default: "btn-glow text-white rounded-xl",
        outline:
          "rounded-xl text-white/70 hover:text-white transition-colors",
        secondary:
          "bg-white/6 text-white/80 hover:bg-white/10 rounded-xl border border-white/10",
        ghost:
